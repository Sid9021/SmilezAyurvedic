            ...
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">What types of Ayurvedic treatments do you offer at Smilez Wellness Centre</span>
                  <ChevronUpIcon
                    className={`${
        ...
        <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white lg:py-8 lg:px-6 p-3 mb-5">
          <Disclosure>
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">Do you provide customized treatment plans based on individual health conditions?</span>
                  <ChevronUpIcon
                    className={`${
                      open ? "rotate-180 transform" : ""
                    } lg:h-5 lg:w-5 h-10 w-10 text-purple-500`}
        ...
        <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white lg:py-8 lg:px-6 p-3 mb-5">
          <Disclosure as="div" className="mt-2">
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">How long do Ayurvedic treatments typically last?</span>
                  <ChevronUpIcon
                    className={`${
                      open ? "rotate-180 transform" : ""
                    } lg:h-5 lg:w-5 h-10 w-10 text-purple-500`}
        ...
        <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white lg:py-8 lg:px-6 p-3 mb-5">
          <Disclosure as="div" className="mt-2">
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">Can I stay at the clinic during my treatment? What accommodations are provided?</span>
                  <ChevronUpIcon
                    className={`${
                      open ? "rotate-180 transform" : ""
                    } lg:h-5 lg:w-5 h-10 w-10 text-purple-500`}
        ...
        <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white lg:py-8 lg:px-6 p-3 mb-5">
          <Disclosure as="div" className="mt-2">
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">Is food included during my stay? Do you offer Ayurvedic meals?</span>
                  <ChevronUpIcon
                    className={`${
                      open ? "rotate-180 transform" : ""
                    } lg:h-5 lg:w-5 h-10 w-10 text-purple-500`}
        ...
        <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white lg:py-8 lg:px-6 p-3 mb-5">
          <Disclosure as="div" className="mt-2">
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">Do I need a prior consultation before starting treatment?</span>
                  <ChevronUpIcon
                    className={`${
                      open ? "rotate-180 transform" : ""
                    } lg:h-5 lg:w-5 h-10 w-10 text-purple-500`}
        ...
        <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white lg:py-8 lg:px-6 p-3 mb-5">
          <Disclosure as="div" className="mt-2">
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">Are the treatments safe for people with pre-existing health conditions?</span>
                  <ChevronUpIcon
                    className={`${
                      open ? "rotate-180 transform" : ""
                    } lg:h-5 lg:w-5 h-10 w-10 text-purple-500`}
        ...
        <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white lg:py-8 lg:px-6 p-3 mb-5">
          <Disclosure as="div" className="mt-2">
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">How do Ayurvedic treatments at Smilez Wellness Centre differ from conventional medical treatments?</span>
                  <ChevronUpIcon
                    className={`${
                      open ? "rotate-180 transform" : ""
                    } lg:h-5 lg:w-5 h-10 w-10 text-purple-500`}
        ...
        <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white lg:py-8 lg:px-6 p-3 mb-5">
          <Disclosure as="div" className="mt-2">
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">How can I schedule a treatment at Smilez Wellness Centre?</span>
                  <ChevronUpIcon
                    className={`${
                      open ? "rotate-180 transform" : ""
                    } lg:h-5 lg:w-5 h-10 w-10 text-purple-500`}
        ...
        <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white lg:py-8 lg:px-6 p-3 mb-5">
          <Disclosure as="div" className="mt-2">
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left lg:text-2xl text-lg font-medium">
                  <span className="w-[350px] lg:w-full">Can I schedule a follow-up consultation after completing my treatment?</span>
                  <ChevronUpIcon
                    className={`${
                      open ? "rotate-180 transform" : ""
                    } lg:h-5 lg:w-5 h-10 w-10 text-purple-500`}
